...
echo.
echo ===============================================================================
echo Generating Project files for VS Code... please wait
echo -------------------------------------------------------------------------------
echo.
...
call "%EngineDir%"\Engine\Build\BatchFiles\GenerateProjectFiles.bat -project="%~dp0\%PROJECT_FILE%" -engine -game -vscode || goto :error

echo.
echo -------------------------------------------------------------------------------
echo Generating Project files for VS Code... DONE!
echo ===============================================================================
